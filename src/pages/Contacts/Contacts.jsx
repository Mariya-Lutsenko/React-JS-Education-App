          ...
          <div className="contacts-right row">
            ...
            <form action={formSpreeEndpoint} method="POST">
              <div className="flexSB">
                <input type="text" name="name"  placeholder="Прізвище Ім'я" required />
                <input type="email" name="_replyto" placeholder="Ваша елнектронна пошта" required/>
              </div>
              <input type="text" name="subject"  placeholder="Тема повідомлення" required/>
              <textarea name="message" cols="30" rows="10" required>
                Напишіть ваше повідомлення...
              </textarea>
              <button type="submit" className="primary-btn">Відправити повідомлення</button>
            </form>
